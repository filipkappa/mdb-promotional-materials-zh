...
---
![Sidenav](https://mdbcdn.b-cdn.net/img/press-pack/components-standard/sidenav.jpg)
...
MDB PRO includes the following plugins:
  ...
  - [Organization chart](https://mdbootstrap.com/docs/standard/plugins/organization-chart/)
